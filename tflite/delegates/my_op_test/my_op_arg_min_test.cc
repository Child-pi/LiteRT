...
TEST(MyOpTestDelegate, ArgMinTest) {
  ArgMinMaxOpModel m(BuiltinOperator_ARG_MIN, {TensorType_FLOAT32, {1, 3}}, 1, TensorType_INT32);
  ...
  EXPECT_THAT(m.GetOutput<int32_t>(), testing::ElementsAre(0));
